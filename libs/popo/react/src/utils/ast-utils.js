...
function addReduxStoreToMain(sourcePath, source, context) {
    ...
    return [
        ...ast_utils_1.addGlobal(source, sourcePath, `import { configureStore, getDefaultMiddleware } from '@reduxjs/toolkit';
