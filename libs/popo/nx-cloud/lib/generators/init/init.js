...
function updateNxJson(json, token) {
    ...
    const options = Object.assign(Object.assign({}, alreadySetOptions), { accessToken: token, canTrackAnalytics: false, showUsageWarnings: true });
...
function createNxCloudWorkspace(workspaceName) {
    return __awaiter(this, void 0, void 0, function* () {
        const apiUrl = removeTrailingSlash(process.env.NRWL_API || `https://api.nrwl.io`);
